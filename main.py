...
#list to hold movies entered to the add function
movie_list = []
...
def crossoff_movie():
    ...
    #remove title from global list
    if crossed_off_movie in movie_list: movie_list.remove(crossed_off_movie)
...
def add_movie():
    ...
    #add title to global list
    movie_list.append(new_movie_escaped)
...
def index():
    ...
    return render_template('edit.html', titles=movie_list, error=encoded_error and cgi.escape(encoded_error, quote=True))
